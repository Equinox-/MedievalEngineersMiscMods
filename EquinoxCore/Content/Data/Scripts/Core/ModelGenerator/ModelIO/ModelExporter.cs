...
namespace Equinox76561198048419394.Core.ModelGenerator.ModelIO
{
    public static class ModelExporter
    {
        ...
        public static Dictionary<string, int> ExportTags(BinaryWriter result, Dictionary<string, object> tagData)
        {
            ...
            index.Add(MyImporterConstants.TAG_TEXCOORDS1, GetCachePosition());
            stream.ExportData(MyImporterConstants.TAG_TEXCOORDS1, (HalfVector2[]) tagData[MyImporterConstants.TAG_TEXCOORDS1]);
            index.Add(MyImporterConstants.TAG_RESCALE_FACTOR, GetCachePosition());
            stream.ExportFloat(MyImporterConstants.TAG_RESCALE_FACTOR, (float) tagData[MyImporterConstants.TAG_RESCALE_FACTOR]);
            index.Add(MyImporterConstants.TAG_USE_CHANNEL_TEXTURES, GetCachePosition());
            stream.ExportBool(MyImporterConstants.TAG_USE_CHANNEL_TEXTURES, (bool) tagData[MyImporterConstants.TAG_USE_CHANNEL_TEXTURES]);
            index.Add(MyImporterConstants.TAG_BOUNDING_BOX, GetCachePosition());
            stream.ExportData(MyImporterConstants.TAG_BOUNDING_BOX, (BoundingBox) tagData[MyImporterConstants.TAG_BOUNDING_BOX]);
            index.Add(MyImporterConstants.TAG_BOUNDING_SPHERE, GetCachePosition());
            stream.ExportData(MyImporterConstants.TAG_BOUNDING_SPHERE, (BoundingSphere) tagData[MyImporterConstants.TAG_BOUNDING_SPHERE]);
            index.Add(MyImporterConstants.TAG_SWAP_WINDING_ORDER, GetCachePosition());
            stream.ExportBool(MyImporterConstants.TAG_SWAP_WINDING_ORDER, (bool) tagData[MyImporterConstants.TAG_SWAP_WINDING_ORDER]);
            index.Add("MeshParts", GetCachePosition());
            stream.ExportData("MeshParts", (List<MyMeshPartInfo>) tagData["MeshParts"]);
            index.Add(MyImporterConstants.TAG_MESH_SECTIONS, GetCachePosition());
            stream.ExportData(MyImporterConstants.TAG_MESH_SECTIONS, (List<MyMeshSectionInfo>) tagData[MyImporterConstants.TAG_MESH_SECTIONS]);
            index.Add(MyImporterConstants.TAG_MODEL_BVH, GetCachePosition());
            stream.ExportData(MyImporterConstants.TAG_MODEL_BVH, (byte[]) tagData[MyImporterConstants.TAG_MODEL_BVH]); // GImpactQuantizedBVH as byte[]
            index.Add(MyImporterConstants.TAG_MODEL_INFO, GetCachePosition());
            stream.ExportData(MyImporterConstants.TAG_MODEL_INFO, (MyModelInfo) tagData[MyImporterConstants.TAG_MODEL_INFO]);
            index.Add(MyImporterConstants.TAG_BLENDINDICES, GetCachePosition());
            stream.ExportData(MyImporterConstants.TAG_BLENDINDICES, (Vector4I[]) tagData[MyImporterConstants.TAG_BLENDINDICES]);
            index.Add(MyImporterConstants.TAG_BLENDWEIGHTS, GetCachePosition());
            stream.ExportData(MyImporterConstants.TAG_BLENDWEIGHTS, (Vector4[]) tagData[MyImporterConstants.TAG_BLENDWEIGHTS]);
            index.Add(MyImporterConstants.TAG_ANIMATIONS, GetCachePosition());
            stream.ExportData(MyImporterConstants.TAG_ANIMATIONS, (ModelAnimations) tagData[MyImporterConstants.TAG_ANIMATIONS]);
            index.Add(MyImporterConstants.TAG_BONES, GetCachePosition());
            stream.ExportData(MyImporterConstants.TAG_BONES, (MyModelBone[]) tagData[MyImporterConstants.TAG_BONES]);
            index.Add(MyImporterConstants.TAG_BONE_MAPPING, GetCachePosition());
            stream.ExportData(MyImporterConstants.TAG_BONE_MAPPING, (Vector3I[]) tagData[MyImporterConstants.TAG_BONE_MAPPING]);
            index.Add(MyImporterConstants.TAG_HAVOK_COLLISION_GEOMETRY, GetCachePosition());
            stream.ExportData(MyImporterConstants.TAG_HAVOK_COLLISION_GEOMETRY, (byte[]) tagData[MyImporterConstants.TAG_HAVOK_COLLISION_GEOMETRY]);
            index.Add(MyImporterConstants.TAG_PATTERN_SCALE, GetCachePosition());
            stream.ExportFloat(MyImporterConstants.TAG_PATTERN_SCALE, (float) tagData[MyImporterConstants.TAG_PATTERN_SCALE]);
            index.Add(MyImporterConstants.TAG_LODS, GetCachePosition());
            stream.ExportData(MyImporterConstants.TAG_LODS, (MyLODDescriptor[]) tagData[MyImporterConstants.TAG_LODS]);
