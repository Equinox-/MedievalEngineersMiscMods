...
namespace Equinox76561198048419394.Core.Cli.Util.Keen
{
    ...
    public static class KeenMaterialExt
    {
        ...
        {
            mtl.ColorMetalTexture = mod.ConvertTexture(mtl.ColorMetalTexture, KeenTexture.ColorMetal, cmFlags ?? defaultFlags);
            mtl.NormalGlossTexture = mod.ConvertTexture(mtl.NormalGlossTexture, KeenTexture.NormalGloss, ngFlags ?? defaultFlags);
            mtl.ExtensionTexture = mod.ConvertTexture(mtl.ExtensionTexture, KeenTexture.Extension, addFlags ?? defaultFlags);
            mtl.AlphaMaskTexture = mod.ConvertTexture(mtl.AlphaMaskTexture, KeenTexture.AlphaMask, alphaMaskFlags ?? defaultFlags);
        }
